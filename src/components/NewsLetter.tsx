            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <form className="mt-8 flex justify-center">
                    <input
                        ...
                        required
                        className="w-full max-w-xs px-4 py-2 text-gray-900 border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-orange-400 focus:outline-none placeholder:text-zinc-950"
                    />
                    <button
                        type="submit"
